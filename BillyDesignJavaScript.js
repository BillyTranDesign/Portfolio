...
/* Mobile nav: the hamburger menu is now handled by pure CSS (a hidden
   checkbox + label in the HTML), so no JavaScript toggle is needed here.
   The old #myTopnav "responsive" toggle was removed because it ran on
   page load and forced the mobile menu open. */
